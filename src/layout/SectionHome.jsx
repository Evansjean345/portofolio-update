  ...
  return (
    <div className="bg-black">
      <div className="w-full px-6">
        <div className="mt-8 bg-slate-600 relative rounded-lg  container mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
          <img
