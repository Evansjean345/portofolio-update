...
export default function Contact() {
  ...
  return (
    <div className="container bg-black mx-auto pt-16 lg:px-12  ">
            ...
            <div className="w-full mt-6">
              ...
              <div className="flex items-center justify-center w-full">
                <button
                  ...
                  className="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-slate-700 rounded hover:bg-slate-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none"
                >
                  envoyer
                </button>
              </div>
